...
import type { RequestOptions, TypeSearchParams } from "./types";
...
export class FetchClient {
  ...
  private creatSearchParams(params: TypeSearchParams): string {
  ...
  private async request<T>(
    ...
    if (options.params) {
      url += this.creatSearchParams(options.params);
    }
